...
class ExpertsCategoryIndexContainer extends React.Component {
  ...
  <div className='industry-experts category-view'>
  ...
  <h2>Category</h2>
    ...
    <div className="expert-bio">Category-- provide unique insights into the news and trends that impact your industry. Leveraging meaningful data coupled with their own extensive experience, our team delivers what matters.
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps )(ExpertsCategoryIndexContainer);
