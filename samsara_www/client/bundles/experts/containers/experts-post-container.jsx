...
import Experts from '../components/experts-index';


class ExpertsAppContainer extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps )(ExpertsAppContainer);
