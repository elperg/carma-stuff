...
// Sentiment Levels
export const SentimentLevels = ['negative', 'somewhat_negative', 'neutral', 'somewhat_positive', 'positive'];

export const MediaSubtypes = [ 'magazine', 'newspaper', 'radio', 'tv', 'website' ];
//
// export const APIURLs = {
//   articles      : '/articles-all.json',
//
//   export_csv    : '/export/csv',
//   export_pdf    : '/export/pdf',
//   export_doc    : '/export/doc',
//   export_doc_clippings    : '/export/doc_clippings',
//   export_rima   : '/export/rima'
// }
...
export const API_HOST = (process.env.API_HOST !== undefined) ? process.env.API_HOST : 'http://localhost:3001';
export const IMGIX_HOST = (process.env.IMGIX_HOST !== undefined) ? process.env.IMGIX_HOST : 'https://bodhi-staging.imgix.net';
export const S3_HOST = (process.env.S3_HOST !== undefined) ? process.env.S3_HOST : 'https:​/​/​bodhi-production-assets.s3.amazonaws.com';


export const MY_CARMA_URL = (process.env.MY_CARMA_URL !== undefined) ? process.env.MY_CARMA_URL : 'https://mycarma.com';
export const TALKWALKER_URL = (process.env.TALKWALKER_URL !== undefined) ? process.env.TALKWALKER_URL : 'https://api.talkwalker.com/api/v2/auth/u/';
