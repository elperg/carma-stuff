...
class ExpertsIndexAppContainer extends React.Component {
  ...
  <ExpertsHeroPosts  {...this.props}  />
    ...
    <div className="expert-bio">CARMA’s sector experts provide unique insights into the news and trends that impact your industry. Leveraging meaningful data coupled with their own extensive experience, our team delivers what matters.
      </div>
